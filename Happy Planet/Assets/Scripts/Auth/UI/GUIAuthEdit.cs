...
public class GUIAuthEdit : GUIPopUp {
    ...
    public override void Open()
    {
        ...
        _defaultName.text = AuthManager.Instance.Auth.GetName();
    ...
    public void Setting()
    {
        ...
        if (_newName.text.CompareTo(_defaultName.text) != 0 && _newName.text.CompareTo("") != 0)
        {
            ...
            AuthManager.Instance.Auth.DisplayNameChange(_newName.text, () =>
            {
        ...
        AuthManager.Instance.Auth.PasswordChange(_newPW.text, () =>
        {
            UIManager.Instance.DisplayMessage("msg_Applied");
    ...
    public void Delete() {
        ...
        Action[] callback = new Action[2]{ () => {
            ...
            AuthManager.Instance.Auth.DeleteUser(() =>
            {
                _loading.LoadingOff();
